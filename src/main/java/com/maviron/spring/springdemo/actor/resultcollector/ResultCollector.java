package com.maviron.spring.springdemo.actor.resultcollector;
...
class RequestWithCollectorActor extends UntypedAbstractActor {
    ...
    public void onReceive(Object message) throws Throwable {
        if (message instanceof Request) {
            ...
            getContext().parent().tell("qqwasda", getSelf());
...
class Actor3 extends UntypedAbstractActor {
    ...
    public void onReceive(Object message) throws Throwable {
        if (message instanceof RequestWithCollector) {
            ...
            req.getCollector().tell(new Request(), getSelf());
        }
    }
}
...
class Main {
    public static void main(String[] args) throws Exception {
        ...
        // 发起 ask 请求
        Future<Object> future = Patterns.ask(actor1, new RequestWithCollector(actor1), timeout);
