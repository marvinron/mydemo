...
class ChainRequest {
    ...
    public ChainRequest(String data) {
        this.data = data;
    }
...
// 请求处理器接口
interface RequestHandler extends Function<ChainRequest, Response> {
...
class UpperCaseHandler implements RequestHandler {
    @Override
    public Response apply(ChainRequest request) {
...
public class ChainOfResponsibilityExample {
    public static void main(String[] args) {
        ...
        // 创建请求对象
        ChainRequest request = new ChainRequest("hello");
