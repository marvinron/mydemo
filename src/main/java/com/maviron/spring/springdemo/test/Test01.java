 ...
 * @Description TODO
 * @createTime 2023年02月17日 10:24:00
 */
public class Test01 {
    /**
     * 短网址生成方法
    ...
    public static void main(String[] args) throws Exception {
        //String shortUrl = getShortUrl("123213123fgdsffsdeqweqweqwdasdasdasdas");
        ...
        String timeStr = DateUtil.parse("2023-03-01").toString("yyyyMM");
        String finalDbName = "dmp_file_new" + "_" + timeStr;
        System.out.println(finalDbName);
    }
}
